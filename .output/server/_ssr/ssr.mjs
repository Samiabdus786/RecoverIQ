...
var client_references_default = {
	"15c18cfaeeff": async () => {
		const m = await import("./layout-segment-context-HzWkCTBS.mjs");
		return { get "LayoutSegmentProvider"() {
			return m["LayoutSegmentProvider"];
		} };
	},
	"195fc1a01ae3": async () => {
		const m = await import("./recoveriq-app-COv9qt7K.mjs");
		return { get "default"() {
			return m["default"];
		} };
	},
	"593f344dc510": async () => {
		const m = await import("./error-boundary-BqAF_M5o.mjs");
		return {
			get "ErrorBoundary"() {
...
//#endregion
export { __commonJSMin, __exportAll, __reExport, __toESM, app_ssr_entry_default as default, getLayoutSegmentContext, handleSsr, require_jsx_runtime, require_react, require_react_dom, usePathname, useRouter };
